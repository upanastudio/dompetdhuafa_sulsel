	                    ...
	                    <div class="card">
	                        ...
	                        <div class="card-body">
	                            ...
	                            <div class="form-group" id="metode-sedekah" style="display: none">
	                                <div class="custom-control custom-radio mb-3">
	                                    <input type="radio" class="custom-control-input" id="metodePembayaran4" name="metodePembayaran" value="BNI Syariah">
	                                    <label class="custom-control-label" for="metodePembayaran4">
	                                        <img src="<?= $aset_url ?>media/logo-bni.png" alt="">
	                                    </label>
	                                </div>
	                                <div class="custom-control custom-radio mb-3">
	                                    <input type="radio" class="custom-control-input" id="metodePembayaran5" name="metodePembayaran" value="Mandiri">
	                                    <label class="custom-control-label" for="metodePembayaran5">
	                                        <img src="<?= $aset_url ?>media/logo-mandiri.png" alt="">
	                                    </label>
	                                </div>
	                                <div class="custom-control custom-radio mb-3">
	                                    <input type="radio" class="custom-control-input" id="metodePembayaran6" name="metodePembayaran" value="Muamalat">
